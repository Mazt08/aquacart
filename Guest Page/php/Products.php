    ...
    <nav class="navbar" role="navigation" aria-label="Main navigation">
        <div class="nav-container">
            ...
            <ul class="nav-menu" role="menubar">
                ...
                <li role="none"><a href="../html/Reviews.html" role="menuitem">Reviews</a></li>
                <li role="none"><a href="../html/Contact.html" role="menuitem">Contact</a></li>
                <li role="none" class="nav-cta"><a href="/LogIn/LogIn.php" role="menuitem" class="btn-login">Log In</a></li>
            </ul>
        </div>
    </nav>
